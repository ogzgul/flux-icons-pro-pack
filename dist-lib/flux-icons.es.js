...
const d = {
  ...
  // --- İNSANLAR & JESTLER ---
  "user-check": '<path d="M16 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="10" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/>',
  // Onaylayan insan
  "hand-heart": '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M12 5l-2 4 4 2-2 4"/>',
  // Kalp tutan el (biraz daha soyut)
  "hand-holding-up": '<path d="M17 10s-1.5-3-3-3h-2c-1.5 0-3 3-3 3v8c0 2 1 4 3 4h2c2 0 3-2 3-4v-8"/>',
  // Yukarı uzanmış el (avuç içi yukarı)
  "hand-holding-down": '<path d="M17 14s-1.5 3-3 3h-2c-1.5 0-3-3-3-3v-8c0-2 1-4 3-4h2c2 0 3 2 3 4v8"/>',
  // Aşağı uzanmış el (avuç içi aşağı)
  // ==========================================
  // 9. MARKALAR & POPÜLER UYGULAMALAR
  // ==========================================
  "brand-apple": '<path fill="currentColor" stroke="none" d="M17.6 18.6c.7.8 1.4.7 1.4.7s3.2-1.3 3.2-4.3c0-3.2-2.7-5-4.7-5-2.2 0-3.1 1.2-4.3 1.2-1.1 0-2.3-1.1-4.1-1.1-2.4 0-4.7 1.6-4.7 5 0 3.8 3.6 8.7 6.8 8.7 1.2 0 2.3-.7 3.4-.7 1 0 2.2.7 3 .5zM15.2 8.6c1-1.1 1.6-2.6 1.5-4.1-1.3.1-2.8.9-3.7 2-1 1.1-1.7 2.6-1.5 4 1.4.1 2.8-.7 3.7-1.9z"/>',
  "brand-windows": '<path d="M2 6l9-1v9H2V6z"/><path d="M2 15h9v9l-9-1v-8z"/><path d="M12 15h10v8l-10-1v-7z"/><path d="M12 5l10-1v9h-10V5z"/>',
  // Windows
  "brand-chrome": '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3"/><path d="M12 9h9"/><path d="M14.5 13.5L10 20"/><path d="M9 13.5L4.5 6"/>',
  // Chrome Tarayıcı
  ...
  "brand-spotify": '<circle cx="12" cy="12" r="10"/><path d="M8 11c3.5-1 7-1 9.5 0"/><path d="M8.5 14c2.5-.8 5-.8 7 0"/><path d="M9 17c1.5-.5 3-.5 4 0"/>',
  "brand-snapchat": '<path d="M12 4c-3 0-5 2-5 5v1c0 1-1 2-3 2 0 3 2 3 2 3v1c0 2 2 4 6 4s6-2 6-4v-1c0 0 2 0 2-3-2 0-3-1-3-2V9c0-3-2-5-5-5z"/>',
  // Snapchat Hayaleti
  "brand-reddit": '<circle cx="12" cy="12" r="10"/><path d="M17 13c.5-.5.5-1.5 0-2s-1.5-.5-2 0"/><path d="M7 11c-.5-.5-1.5-.5-2 0s-.5 1.5 0 2"/><path d="M15 16c-1 1-3 1-4 0"/><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="6" x2="16" y2="5"/><circle cx="17" cy="5" r="1"/>',
  // Reddit Alien
  ...
  // ==========================================
  "app-notes": '<path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M15 2v4"/><path d="M9 2v4"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/><line x1="8" y1="18" x2="12" y2="18"/>',
  // Not Defteri
  "app-calculator": '<rect x="6" y="2" width="12" height="20" rx="2"/><line x1="6" y1="8" x2="18" y2="8"/><line x1="12" y1="14" x2="12" y2="18"/><line x1="10" y1="16" x2="14" y2="16"/>',
  // Hesap Makinesi
  "app-wallet": '<path d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4"/><path d="M4 6v12a2 2 0 0 0 2 2h14v-4"/><path d="M18 12a2 2 0 0 0 0 4h4v-4h-4z"/>',
  // Cüzdan
  "app-compass": '<circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/>',
  // Pusula
  "app-photos": '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>',
  // Galeri / Fotoğraflar
  "app-clock": '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
  // Saat
  "app-maps": '<polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/><line x1="8" y1="2" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="22"/>',
  // Harita
  "app-mic": '<path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/>',
  // Ses Kaydedici
  ...
  "emoji-love": '<circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><path d="M9 8l-1 1.5h2L9 11"/><path d="M15 8l-1 1.5h2L15 11"/>',
  // Kalp gözlü alternatifi
  // 5. TAŞITLAR & SEYAHAT
  // =================================================
  ...
  discount: '<path d="M3 12h18"/><path d="M12 3v18"/><circle cx="12" cy="12" r="9"/>',
  // Yüzde simgesi yerine basit indirim etiketi
  ...
  "truck-delivery": '<rect x="1" y="3" width="15" height="13" rx="2"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/><line x1="2" y1="10" x2="8" y2="10"/>',
  // Hızlı kargo çizgili
  // =================================================
  ...
  "leaf-maple": '<path d="M2 12h1"/><path d="M21 12h1"/><path d="M12 2v1"/><path d="M12 21v1"/><path d="M12 8c-3.87 0-7 3.13-7 7h14c0-3.87-3.13-7-7-7z"/>',
  // Basitleştirilmiş
  ...
  "brand-codepen": '<path fill="none" stroke="currentColor" stroke-width="2" d="M12 2L3 9l9 7 9-7-9-7zm0 14l-9 7 9 7 9-7-9-7zm0-7v7m-9 7v-7m18 7v-7"/>',
  // Codepen çizgisel daha iyi durur
  ...
  "zodiac-cancer": '<path d="M6 12a6 6 0 0 0 12 0"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="12" r="3"/><path d="M18 12a6 6 0 0 0-12 0" transform="rotate(180 12 12)"/>',
  // Basitleştirilmiş Yengeç
  ...
  // =================================================
  "tennis-ball": '<circle cx="12" cy="12" r="10"/><path d="M2 12a10 10 0 0 0 20 0"/><path d="M12 2a10 10 0 0 1 0 20"/>',
  // Basit çizim
  ...
  confetti: '<path d="M12 2v2"/><path d="M12 20v2"/><path d="M4.93 4.93l1.41 1.41"/><path d="M17.66 17.66l1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="M6.34 17.66l-1.41 1.41"/><path d="M19.07 4.93l-1.41 1.41"/><circle cx="12" cy="12" r="4"/>',
  // Havai fişek efekti
  ...
  // =================================================
  "brand-vercel": '<path fill="currentColor" stroke="none" d="M12 1L24 22H0L12 1z"/>',
  // Üçgen (Vercel/Next.js)
  "brand-npm": '<path fill="currentColor" stroke="none" d="M1 8h22v7H11v2H7.5v-2H1V8zm2 5h2v-2H3v2zm5 0h2v2h-2v-2zm7 0h2v-2h-2v2z"/>',
  "brand-copilot": '<path fill="currentColor" stroke="none" d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 4c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6z"/>',
  // Göz benzeri
  ...
  spoon: '<path d="M12 22v-9"/><path d="M12 13a4 4 0 0 1 4-4h0a4 4 0 0 0 4-4V2h-8v3a4 4 0 0 0 4 4h0a4 4 0 0 1-4 4z" transform="rotate(180 12 12)"/>',
  // Basit kaşık
  ...
  // =================================================
  gavel: '<path d="M14 13l-7.5 7.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L11 10"/><path d="M16 16l6-6"/><path d="M8 8l6-6"/><path d="M9 7l8 8"/><path d="M21 11l-8-8"/>',
  // Avukat Tokmağı
  scales: '<path d="M16 3h5v5"/><path d="M8 3H3v5"/><path d="M12 3v10"/><path d="M6 8l-4 9.5a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2L6 8"/><path d="M18 8l-4 9.5a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2L18 8"/>',
  // Adalet Terazisi
  "badge-police": '<path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.78 4.78 4 4 0 0 1-6.74 0 4 4 0 0 1-4.78-4.78 4 4 0 0 1 0-6.74Z"/>',
  // Polis Rozeti
  ...
  "briefcase-medical": '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/><path d="M12 12v4"/><path d="M10 14h4"/>',
  // Doktor Çantası
  ...
  // =================================================
  "face-clown": '<circle cx="12" cy="12" r="10"/><path d="M12 17a3 3 0 0 0 2-2.5V14h-4v.5A3 3 0 0 0 12 17z"/><path d="M9 10h.01"/><path d="M15 10h.01"/><circle cx="12" cy="12" r="1.5"/>',
  // Palyaço
  ...
  "loader-4": '<circle cx="12" cy="12" r="10" stroke-dasharray="10 20"/>',
  // Dönen kesik daire
  ...
  "star-david": '<path d="M12 2l3 5h6l-5 4 2 6-6-4-6 4 2-6-5-4h6z"/>',
  // Basit yıldız formu
  ...
  om: '<path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8z"/>',
  // Sembolik daire
  ...
  // =================================================
  "face-vomit": '<circle cx="12" cy="12" r="10"/><path d="M9 10h.01"/><path d="M15 10h.01"/><path d="M12 15v4"/><path d="M10 17l-3 3"/><path d="M14 17l3 3"/>',
  // Kusmuk Yüz
  "duck-quack": '<path d="M21 9l-4-3-4 3 4 3 4-3z"/><path d="M12 21h-2a4 4 0 0 1-4-4V7a4 4 0 0 1 4-4h2a4 4 0 0 1 4 4v10a4 4 0 0 1-4 4z"/>',
  // Gaga Açık Ördek
  "snail-trail": '<circle cx="12" cy="12" r="6"/><path d="M16 12h-4"/><path d="M6 12a6 6 0 0 0 12 0"/><path d="M2 12s2-2 4-2 4 2 4 2"/><path d="M12 18s2 2 4 2 4-2 4-2"/>',
  // Salyangoz ve İzi
  ...
  potion: '<path d="M19 21H5a2 2 0 0 1-2-2V11l4-4h10l4 4v8a2 2 0 0 1-2 2Z"/><path d="M12 7V3"/><path d="M10 3h4"/><path d="M12 14a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>',
  // İksir şişesi
  scroll: '<path d="M19 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2ZM5 6h14"/><path d="M8 10h8"/><path d="M8 14h5"/>',
  // Büyü parşömeni
  d20: '<path d="M12 2L3 7l9 15 9-15-9-5z"/><path d="M3 7l9 5 9-5"/><path d="M12 12v10"/><path d="M12 12L3 7"/><path d="M12 12l9-5"/>',
  // 20 yüzlü zar
  ...
  "alien-pixel": '<path d="M4 8h16"/><path d="M4 8v6h2v2h2v-2h8v2h2v-2h2V8"/><rect x="7" y="10" width="2" height="2"/><rect x="15" y="10" width="2" height="2"/><line x1="2" y1="16" x2="2" y2="18"/><line x1="22" y1="16" x2="22" y2="18"/>',
  // Space Invader tarzı
  // =================================================
  ...
  // Kafası patlayan
  "cool-shades": '<path d="M4 10h16"/><path d="M4 10l2 6h4l2-6"/><path d="M12 10l2 6h4l2-6"/><path d="M20 10v-1a2 2 0 0 0-2-2h-2"/>',
  // "Deal With It" gözlüğü
  "poop-smile": '<path d="M12 2c-2 0-3.5 1.5-3.5 3.5 0 .5.1 1 .3 1.5-1.5 1-2.3 2.5-2.3 4.5 0 1.5.5 2.5 1.5 3.5-1.5 1-2.5 2.5-2.5 4.5 0 2.5 2.5 4.5 6.5 4.5s6.5-2 6.5-4.5c0-2-1-3.5-2.5-4.5 1-1 1.5-2 1.5-3.5 0-2-.8-3.5-2.3-4.5.2-.5.3-1 .3-1.5C15.5 3.5 14 2 12 2z"/><path d="M9 12h.01"/><path d="M15 12h.01"/><path d="M10 16s1 1 2 1 2-1 2-1"/>',
  // Gülen kaka
  // =================================================
  ...
  // =================================================
  gardening: '<path d="M8 22v-9a4 4 0 0 1 4-4h0a4 4 0 0 1 4 4v9"/><path d="M8 13a4 4 0 1 0-8 0"/><path d="M16 13a4 4 0 1 1 8 0"/><path d="M12 22V9"/>',
  // Sulama kabı gibi stilize
  ...
  yarn: '<circle cx="12" cy="12" r="10"/><path d="M2.5 12h19"/><path d="M12 2.5v19"/><path d="M5 17l14-10"/><path d="M5 7l14 10"/>',
  // İplik yumağı
  // =================================================
  // 124. GARİP & RASTGELE (RANDOM WEIRD)
  // =================================================
  "ufo-abduction": '<path d="M2 10h20"/><path d="M5 10c0-4 2-8 7-8s7 4 7 8"/><path d="M12 10v11"/><path d="M9 21l3-3 3 3"/><path d="M10 14h4"/>',
  // UFO kaçırma
  "toilet-paper": '<ellipse cx="6" cy="8" rx="3" ry="5"/><path d="M9 8v10c0 2.8-1.3 5-3 5s-3-2.2-3-5V8"/><path d="M9 8h10c1.7 0 3 2.2 3 5v3"/>',
  // Tuvalet kağıdı
  ...
  // Farklı bir elmas
  sparkles: '<path d="M12 2l2.4 7.2h7.2l-5.8 4.2 2.2 7.2-5.8-4.2-5.8 4.2 2.2-7.2-5.8-4.2h7.2z"/>',
  // Parlıltı
  // =================================================
  ...
  "trash-lines": '<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M10 12h4"/><path d="M10 16h4"/>',
  // Yatay çizgili
  "trash-x": '<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M10 11l4 6"/><path d="M14 11l-4 6"/>',
  // İçinde çarpı var
  "trash-check": '<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M9 14l2 2 4-4"/>',
  // Silindi onayı
  "trash-off": '<line x1="2" y1="2" x2="22" y2="22"/><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/>',
  // Silinemez
  // =================================================
  // 130. EV & ANA SAYFA TÜREVLERİ (HOME VARIANTS)
  // =================================================
  "home-simple": '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>',
  // Kapısız
  "home-door": '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M10 22v-6h4v6"/>',
  // Sadece kapı
  "home-window": '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><rect x="9" y="12" width="6" height="6" rx="1"/>',
  // Pencereli
  "home-garage": '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M2 22h20"/><rect x="7" y="14" width="10" height="8"/>',
  // Garajlı
  ...
  // =================================================
  gemini: '<path d="M12 2L9.5 9.5L2 12l7.5 2.5L12 22l2.5-7.5L22 12l-7.5-2.5z"/><path d="M12 8l-1 4-4 1 4 1 1 4 1-4 4-1-4-1z" opacity="0.5"/>',
  // Bizim Gem İkonumuz
  "badge-4k": '<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M6 9v3h2"/><path d="M8 9v6"/><path d="M12 9v6"/><path d="M12 12l3-3"/><path d="M12 12l3 3"/>',
  // 4K
  "badge-hd": '<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M6 9v6"/><path d="M10 9v6"/><path d="M6 12h4"/><path d="M14 9v6h2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-2z"/>',
  // HD
  ...
  // Klasik yarım daire
  "loader-dots": '<circle cx="12" cy="12" r="3"/><circle cx="20" cy="12" r="3" opacity="0.5"/><circle cx="4" cy="12" r="3" opacity="0.5"/>',
  // Yanıp sönen noktalar
  "loader-pinwheel": '<path d="M21 12a9 9 0 1 1-9-9c.9 0 1.8.2 2.6.5"/><path d="M12 12l5-5"/><path d="M12 12v-8"/><path d="M12 12H4"/>',
  // Rüzgar gülü tarzı
  "loader-quarter": '<path d="M12 2v4"/><path d="M12 18v4"/><path d="M4.93 4.93l2.83 2.83"/><path d="M16.24 16.24l2.83 2.83"/><path d="M2 12h4"/><path d="M18 12h4"/><path d="M4.93 19.07l2.83-2.83"/><path d="M16.24 7.76l2.83-2.83"/>',
  // Kesik çizgili saat
  "loader-progress": '<rect x="2" y="10" width="20" height="4" rx="2"/><line x1="2" y1="12" x2="12" y2="12"/>',
  // Yükleme çubuğu
  "hourglass-flow": '<path d="M17 22v-9l-3-4 3-5h-9l3 5-3 4v9h9z"/><path d="M12 2v2"/><path d="M12 11v3"/>',
  // Kum saati akıyor
  "refresh-dot": '<path d="M21 12a9 9 0 1 1-2.6-6.4"/><circle cx="20" cy="4" r="2"/>',
  // Noktalı yenileme
  // =================================================
  // 136. AYARLAR & ÇARKLAR (GEARS & SETTINGS)
  // =================================================
  gear: '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1.82.33l.06.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0-2.83l-.06-.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1Z"/>',
  // Klasik çark
  gears: '<circle cx="7" cy="7" r="3"/><circle cx="17" cy="17" r="3"/><path d="M12 7h2"/><path d="M7 12v2"/><path d="M14 17h-2"/><path d="M17 14v-2"/>',
  // İkili basit çark
  "settings-code": '<path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1.82.33l.06.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0-2.83l-.06-.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1Z"/><polyline points="9 12 7 14 9 16"/><polyline points="15 12 17 14 15 16"/>',
  // Çark içinde kod
  // =================================================
  ...
  // =================================================
  "flag-tr": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#E30A17" stroke="none"/><circle cx="9" cy="12" r="3.5" fill="#ffffff"/><circle cx="10.2" cy="12" r="2.8" fill="#E30A17"/><polygon fill="#ffffff" points="15 9.5 15.6 11.3 17.5 11.3 16 12.4 16.6 14.2 15 13.1 13.4 14.2 14 12.4 12.5 11.3 14.4 11.3"/>',
  "flag-us": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#B22234" stroke="none"/><path fill="#ffffff" stroke="none" d="M2 6h20v2H2zm0 4h20v2H2zm0 4h20v2H2zm0 4h20v2H2z"/><rect x="2" y="4" width="9" height="8" rx="1" fill="#3C3B6E" stroke="none"/>',
  // ABD 🇺🇸
  "flag-de": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#FFCE00" stroke="none"/><path fill="#DD0000" stroke="none" d="M2 4h20v10.6H2z"/><path fill="#000000" stroke="none" d="M2 4h20v5.3H2z"/>',
  // ALMANYA 🇩🇪
  "flag-fr": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#FFFFFF" stroke="none"/><path fill="#0055A4" stroke="none" d="M2 4h6.6v16H2z"/><path fill="#EF4135" stroke="none" d="M15.4 4H22v16h-6.6z"/>',
  // FRANSA 🇫🇷
  "flag-gb": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#012169" stroke="none"/><path stroke="#ffffff" stroke-width="3" d="M2 4l20 16m0-16L2 20m10-16v16m-10-8h20"/><path stroke="#C8102E" stroke-width="1.5" d="M2 4l20 16m0-16L2 20m10-16v16m-10-8h20"/>',
  // İNGİLTERE 🇬🇧
  "flag-it": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#FFFFFF" stroke="none"/><path fill="#009246" stroke="none" d="M2 4h6.6v16H2z"/><path fill="#CE2B37" stroke="none" d="M15.4 4H22v16h-6.6z"/>',
  // İTALYA 🇮🇹
  "flag-jp": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#FFFFFF" stroke="#e5e7eb" stroke-width="1"/><circle cx="12" cy="12" r="5" fill="#BC002D" stroke="none"/>',
  // JAPONYA 🇯🇵
  "flag-ru": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#D52B1E" stroke="none"/><path fill="#0039A6" stroke="none" d="M2 4h20v10.6H2z"/><path fill="#FFFFFF" stroke="none" d="M2 4h20v5.3H2z"/>',
  // RUSYA 🇷🇺
  "flag-cn": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#DE2910" stroke="none"/><path fill="#FFDE00" stroke="none" d="M5 6l1 3h-3l2.5 1.5L4.5 13 7 11l2.5 2-.9-2.5L11 9H8z"/>',
  // ÇİN 🇨🇳
  "flag-es": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#AA151B" stroke="none"/><rect x="2" y="7" width="20" height="10" fill="#F1BF00" stroke="none"/>',
  // İSPANYA 🇪🇸
  "flag-ua": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#FFD700" stroke="none"/><path fill="#0057B8" stroke="none" d="M2 4h20v8H2z"/>',
  // UKRAYNA 🇺🇦
  "flag-az": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#3F9C35" stroke="none"/><path fill="#ED2939" stroke="none" d="M2 4h20v10.6H2z"/><path fill="#00B5E2" stroke="none" d="M2 4h20v5.3H2z"/><path fill="white" d="M11 12a2 2 0 1 1-1 0z" stroke="none"/>',
  // AZERBAYCAN 🇦🇿
  "flag-eu": '<rect x="2" y="4" width="20" height="16" rx="2" fill="#003399" stroke="none"/><circle cx="12" cy="12" r="5" stroke="#FFCC00" stroke-width="1" stroke-dasharray="1 3"/>',
  // AVRUPA BİRLİĞİ 🇪🇺
  // =================================================
  ...
  // =================================================
  exchange: '<path d="M17 20V4L7 14"/><path d="M7 4v16l10-10"/>',
  // Çapraz değişim
  ...
  // =================================================
  "cart-plus": '<circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/><line x1="19" y1="11" x2="19" y2="17"/><line x1="16" y1="14" x2="22" y2="14"/>',
  // Sepete ekle
  "cart-minus": '<circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/><line x1="16" y1="11" x2="22" y2="11"/>',
  // Sepetten çıkar
  "cart-check": '<circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/><path d="M16 10l2 2 4-4"/>',
  // Sepet onaylı
  "cart-x": '<circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/><line x1="17" y1="9" x2="21" y2="13"/><line x1="21" y1="9" x2="17" y2="13"/>',
  // Sepet iptal
  ...
  "star-half-filled": '<path fill="currentColor" stroke="none" d="M12 17.77v-15.8l3.09 6.26 6.91 1.01-5 4.87 1.18 6.88z"/><path stroke="currentColor" stroke-width="2" fill="none" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>',
  // Yarım yıldız
  "star-off": '<line x1="2" y1="2" x2="22" y2="22"/><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',
  // Çizik yıldız
  ...
  // Boş
  "battery-eco": '<rect x="1" y="6" width="18" height="12" rx="2"/><line x1="23" y1="13" x2="23" y2="11"/><path d="M9 15l2-6h-4l2-6"/>',
  // Tasarruf modu (Yaprak yerine şimşek)
  // =================================================
  ...
  // Yüksek ses
  "wifi-low": '<path d="M12 20h.01"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/>',
  // Düşük sinyal
  ...
  // =================================================
  "user-online": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><circle cx="20" cy="21" r="2" fill="#10B981" stroke="none"/>',
  // Yeşil noktalı
  "user-offline": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><circle cx="20" cy="21" r="2" fill="#9CA3AF" stroke="none"/>',
  // Gri noktalı
  "user-busy": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><circle cx="20" cy="21" r="2" fill="#EF4444" stroke="none"/>',
  // Kırmızı noktalı
  ...
  "battery-saving": '<rect x="1" y="6" width="18" height="12" rx="2"/><line x1="23" y1="13" x2="23" y2="11"/><path d="M9 15l2-6h-4l2-6"/>',
  // Şimşekli
  // =================================================
  ...
  // =================================================
  "search-map": '<circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><path d="M11 8v6"/><path d="M8 11h6"/>',
  // Haritada ara
  "search-doc": '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="10" cy="14" r="2"/><line x1="11.5" y1="15.5" x2="13" y2="17"/>',
  // Belge içi arama
  ...
  "menu-veggie": '<circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/>',
  // Dikey 3 nokta
  "menu-meatball": '<circle cx="12" cy="12" r="1"/><circle cx="5" cy="12" r="1"/><circle cx="19" cy="12" r="1"/>',
  // Yatay 3 nokta
  ...
  "menu-motion": '<line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="15" y2="6"/><line x1="9" y1="18" x2="21" y2="18"/>',
  // Hareketli hissi veren
  // =================================================
  ...
  // Güneş gözlüklü (Detaylı)
  // --- NEGATİF DUYGULAR ---
  "emoji-angry-2": '<circle cx="12" cy="12" r="10"/><path d="M8 16s1.5-1 4-1 4 1 4 1"/><line x1="9" y1="10" x2="9.01" y2="10"/><line x1="15" y1="10" x2="15.01" y2="10"/><path d="M7 8l3 1"/><path d="M17 8l-3 1"/>',
  // Kaşları çatık
  "emoji-dizzy": '<circle cx="12" cy="12" r="10"/><path d="M8 15s1.5 1 4 1 4-1 4-1"/><path d="M9 9l2 2m-2 0l2-2"/><path d="M13 9l2 2m-2 0l2-2"/>',
  // Sersemlemiş (X gözlü)
  "emoji-frown": '<circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/><path d="M7 7l2 1"/><path d="M17 7l-2 1"/>',
  // Üzgün ve kaşları düşük
  "emoji-scream": '<circle cx="12" cy="12" r="10"/><ellipse cx="12" cy="16" rx="2" ry="4"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/><path d="M18 14l2-4"/><path d="M6 14l-2-4"/>',
  // Çığlık (Eller yanda)
  "emoji-silent": '<circle cx="12" cy="12" r="10"/><line x1="9" y1="10" x2="9.01" y2="10"/><line x1="15" y1="10" x2="15.01" y2="10"/><path d="M8 15h8"/><line x1="12" y1="13" x2="12" y2="17"/>',
  // Ağzı fermuarlı/kapalı (Sessiz)
  // --- ŞAŞKIN & DÜŞÜNCELİ ---
  ...
  // İfadesiz (Düz çizgi gözler)
  // --- HASTA & DURUM ---
  "emoji-sleep-zzz": '<circle cx="12" cy="12" r="10"/><path d="M8 15h8"/><line x1="9" y1="10" x2="11" y2="10"/><line x1="13" y1="10" x2="15" y2="10"/><path d="M18 4l2-2"/><path d="M20 7l3-3"/><path d="M16 3l1-1"/>',
  // Uyuyan (Zzz)
  // --- EĞLENCELİ DETAYLAR ---
  "emoji-wink-tongue": '<circle cx="12" cy="12" r="10"/><path d="M12 14v2a2 2 0 0 0 4 0v-2"/><path d="M8 14h8"/><path d="M9 9h.01"/><path d="M14.5 9a2.5 2.5 0 0 0 0 1"/>',
  // Göz kırpıp dil çıkaran
  "emoji-tongue": '<circle cx="12" cy="12" r="10"/><path d="M12 14v2a2 2 0 0 0 4 0v-2"/><path d="M8 14h8"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/>',
  // Dil çıkaran
  "emoji-kiss": '<circle cx="12" cy="12" r="10"/><path d="M12 15l-2-2 2-2 2 2-2 2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/><path d="M12 15v2"/><path d="M10 17h4"/>',
  // Öpücük atan
  "emoji-surprise-2": '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="16" r="3"/><path d="M9 9a2 2 0 0 1 2-2"/><path d="M15 9a2 2 0 0 0-2-2"/>',
  // Şok olmuş (Büyük ağız)
  ...
  // --- PROFİL TİPLERİ ---
  "user-square": '<rect x="4" y="4" width="16" height="16" rx="4"/><circle cx="12" cy="10" r="3"/><path d="M7 17c0-3 2.5-5 5-5s5 2 5 5"/>',
  // Kare çerçeveli
  "user-circle-alt": '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="9" r="3"/><path d="M6.5 18a6 6 0 0 1 11 0"/>',
  // Yuvarlak çerçeveli (daha sade)
  "user-scan": '<path d="M6 3H4a2 2 0 0 0-2 2v2"/><path d="M20 3h2a2 2 0 0 1 2 2v2"/><path d="M20 21h2a2 2 0 0 0 2-2v-2"/><path d="M6 21H4a2 2 0 0 1-2-2v-2"/><circle cx="12" cy="10" r="3"/><path d="M7 18c0-3 2.5-5 5-5s5 2 5 5"/>',
  // Yüz tarama / Kimlik doğrulama
  "user-id": '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="2"/><path d="M15 8h2"/><path d="M15 12h2"/><path d="M7 16h10"/>',
  // Kimlik kartı
  // --- ROLLER & MESLEKLER ---
  "user-admin": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M16 3l4 4"/><path d="M20 3l-4 4"/>',
  // X gözlü veya farklı (Admin yetkisi) - Düzeltme: Kral tacı gibi
  "user-crown": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M9 2l3 3 3-3"/>',
  // Taçlı kullanıcı (Admin/VIP)
  "user-doctor": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M10 3h4"/><path d="M12 1v4"/>',
  // Doktor (Artı işaretli)
  "user-student": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="9" r="3"/><path d="M12 2l-8 4 8 4 8-4-8-4z"/><path d="M20 6v6"/>',
  // Mezuniyet şapkalı
  // --- KULLANICI ETKİLEŞİMLERİ ---
  "user-edit": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M18 11l3-3"/><path d="M17 8l2 2"/>',
  // Düzenle
  "user-settings": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><circle cx="20" cy="4" r="2"/>',
  // Ayarlar (Çarklı)
  "user-heart": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M19 6a2 2 0 0 1 2.8 2.8L19 11l-2.8-2.8A2 2 0 0 1 19 6z"/>',
  // Favori kullanıcı
  "user-share": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M16 3l5 5-5 5"/><path d="M21 8H15"/>',
  // Paylaş
  "user-voice": '<path d="M20 21v-2a4 4 0 0 0-3-3.8"/><path d="M4 21v-2a4 4 0 0 1 4-4h3"/><circle cx="12" cy="7" r="4"/><path d="M19 4a5 5 0 0 1 0 6"/><path d="M22 2a9 9 0 0 1 0 10"/>',
  // Konuşan kullanıcı (Ses dalgası)
  // --- GRUPLAR VE ÇOKLU KULLANICI ---
  "users-plus": '<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',
  // Kullanıcı ekle (daha temiz)
  "users-minus": '<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="23" y1="11" x2="17" y2="11"/>',
  // Kullanıcı sil
  "users-cog": '<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><circle cx="20" cy="11" r="2"/>',
  // Grup ayarları
  // =================================================
  ...
  "pixel-mug": '<path d="M4 6h12v10h-2v2H6v-2H4V6zm12 2h2v4h-2V8z" fill="currentColor" stroke="none"/><path d="M6 4h2v-2h-2v2zm4 0h2v-2h-2v2zm4 0h2v-2h-2v2z" fill="currentColor" opacity="0.5"/>',
  // Buharlı
  ...
  "user-mute-outline": '<circle cx="9" cy="7" r="4" stroke="currentColor" stroke-width="2" fill="none"/><path d="M2 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M22 9l-6 6M16 9l6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',
  // Ağzı çarpı ile kapalı gibi
  ...
  "border-tl": '<path d="M4 12V4h8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M12 4h8v16H4v-8" stroke="currentColor" stroke-width="2" stroke-opacity="0.2" fill="none"/>',
  // Top-Left
  "border-tr": '<path d="M12 4h8v8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M20 12v8H4V4h8" stroke="currentColor" stroke-width="2" stroke-opacity="0.2" fill="none"/>',
  // Top-Right
  "border-bl": '<path d="M4 12v8h8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M12 20h8V4H4v8" stroke="currentColor" stroke-width="2" stroke-opacity="0.2" fill="none"/>',
  // Bottom-Left
  "border-br": '<path d="M20 12v8h-8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M12 20H4V4h16v8" stroke="currentColor" stroke-width="2" stroke-opacity="0.2" fill="none"/>',
  // Bottom-Right
  ...
  "radius-all": '<rect x="4" y="4" width="16" height="16" rx="6" stroke="currentColor" stroke-width="2" fill="none"/>',
  // Tam oval
  "radius-none": '<rect x="4" y="4" width="16" height="16" rx="0" stroke="currentColor" stroke-width="2" fill="none"/>',
  // Tam kare
