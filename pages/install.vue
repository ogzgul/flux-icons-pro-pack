    ...
    <div class="space-y-12">
        ...
        <section class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm relative overflow-hidden">
            ...
            <div class="bg-slate-950 text-slate-200 p-4 rounded-lg font-mono text-xs md:text-sm flex justify-between items-center gap-4">
                <span class="break-all text-indigo-300">&lt;link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flux-icons-pro-pack@1.0.27/dist-font/flux-icons.css" /&gt;</span>
               <button 
  @click="copyToClipboard('<link rel=\'stylesheet\' href=\'https://cdn.jsdelivr.net/npm/flux-icons-pro-pack@1.0.27/dist-font/flux-icons.css\' />', 'cdn')" 
