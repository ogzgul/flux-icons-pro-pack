export const aeroIcons = {
    ...
    "aero-load-spin-blue": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><circle cx="12" cy="12" r="10" stroke="#E2E8F0" stroke-width="2" fill="none"/><path d="M12 2a10 10 0 0 1 10 10" stroke="url(#g1)" stroke-width="3" stroke-linecap="round" fill="none"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-spin-purple": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#C084FC"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs><circle cx="12" cy="12" r="10" stroke="#F3E8FF" stroke-width="2" fill="none"/><path d="M12 22a10 10 0 0 1-10-10" stroke="url(#g2)" stroke-width="3" stroke-linecap="round" fill="none"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-spin-green": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><circle cx="12" cy="12" r="10" stroke="#DCFCE7" stroke-width="2" fill="none"/><path d="M2 12a10 10 0 0 1 10-10" stroke="url(#g3)" stroke-width="3" stroke-linecap="round" fill="none"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-dots": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="4" cy="12" r="3" fill="#60A5FA"><animate attributeName="cy" values="12;6;12" dur="0.6s" repeatCount="indefinite"/></circle><circle cx="12" cy="12" r="3" fill="#818CF8"><animate attributeName="cy" values="12;6;12" dur="0.6s" begin="0.2s" repeatCount="indefinite"/></circle><circle cx="20" cy="12" r="3" fill="#A78BFA"><animate attributeName="cy" values="12;6;12" dur="0.6s" begin="0.4s" repeatCount="indefinite"/></circle></svg>`,
    "aero-load-pulse-red": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="8" fill="#FCA5A5"><animate attributeName="r" values="8;11;8" dur="1.5s" repeatCount="indefinite"/><animate attributeName="opacity" values="1;0.5;1" dur="1.5s" repeatCount="indefinite"/></circle><circle cx="12" cy="12" r="5" fill="#DC2626"/></svg>`,
    "aero-load-bar-blue": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="10" width="20" height="4" rx="2" fill="#DBEAFE"/><rect x="2" y="10" width="8" height="4" rx="2" fill="#2563EB"><animate attributeName="x" values="2;14;2" dur="1.5s" repeatCount="indefinite"/></rect></svg>`,
    "aero-load-ring-dual": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="8" stroke="#3B82F6" stroke-width="2" fill="none" stroke-dasharray="20 10"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="2s" repeatCount="indefinite"/></circle><circle cx="12" cy="12" r="4" stroke="#F472B6" stroke-width="2" fill="none" stroke-dasharray="10 5"><animateTransform attributeName="transform" type="rotate" from="360 12 12" to="0 12 12" dur="2s" repeatCount="indefinite"/></circle></svg>`,
    "aero-load-cube": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="8" y="8" width="8" height="8" rx="1" fill="#F59E0B"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1.5s" repeatCount="indefinite"/><animate attributeName="opacity" values="1;0.5;1" dur="1.5s" repeatCount="indefinite"/></rect></svg>`,
    "aero-load-liquid": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="gL" x1="0" y1="1" x2="0" y2="0"><stop offset="0%" stop-color="#3B82F6"/><stop offset="100%" stop-color="#60A5FA"/></linearGradient></defs><rect x="6" y="2" width="12" height="20" rx="3" stroke="#1D4ED8" stroke-width="1" fill="none"/><rect x="7" y="18" width="10" height="0" rx="2" fill="url(#gL)"><animate attributeName="height" values="0;16;0" dur="2s" repeatCount="indefinite"/><animate attributeName="y" values="21;5;21" dur="2s" repeatCount="indefinite"/></rect></svg>`,
    "aero-load-infinity": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8 8c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4zm8 0c2.2 0 4 1.8 4 4s-1.8 4-4 4-4-1.8-4-4 1.8-4 4-4z" stroke="#8B5CF6" stroke-width="2" fill="none" stroke-dasharray="5 5"><animate attributeName="stroke-dashoffset" from="20" to="0" dur="1s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-radar": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="#10B981" stroke-width="1" fill="none"/><line x1="12" y1="12" x2="12" y2="2" stroke="#34D399" stroke-width="2"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1.5s" repeatCount="indefinite"/></line><circle cx="12" cy="12" r="10" fill="#10B981" opacity="0.1"><animate attributeName="opacity" values="0.1;0.3;0.1" dur="1.5s" repeatCount="indefinite"/></circle></svg>`,
    "aero-load-gear": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" fill="#64748B" opacity="0.5"/><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12s4.48 10 10 10 10-4.48 10-10zm-2 0c0 4.41-3.59 8-8 8s-8-3.59-8-8 3.59-8 8-8 8 3.59 8 8z" fill="#334155"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="3s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-hourglass": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6 2v20h12v-20z" fill="none" stroke="#475569" stroke-width="2"/><path d="M6 2h12l-6 10 6 10h-12l6-10z" fill="#F59E0B"><animate attributeName="d" values="M6 2h12l-6 10 6 10h-12l6-10z; M6 2h12l-6 0 6 0h-12l6 0z; M6 2h12l-6 10 6 10h-12l6-10z" dur="3s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-wifi": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" fill="#6366F1"><animate attributeName="opacity" values="0.3;1;0.3" dur="1s" repeatCount="indefinite"/></path><path d="M8.5 14a5 5 0 0 1 7 0" stroke="#6366F1" stroke-width="2" stroke-linecap="round" opacity="0.3"><animate attributeName="opacity" values="0.3;1;0.3" dur="1s" begin="0.3s" repeatCount="indefinite"/></path><path d="M5 10a10 10 0 0 1 14 0" stroke="#6366F1" stroke-width="2" stroke-linecap="round" opacity="0.3"><animate attributeName="opacity" values="0.3;1;0.3" dur="1s" begin="0.6s" repeatCount="indefinite"/></path></svg>`,
    "aero-load-upload": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 16V8" stroke="#3B82F6" stroke-width="2" stroke-linecap="round"/><path d="M9 11l3-3 3 3" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><animateTransform attributeName="transform" type="translate" values="0,0; 0,-5; 0,0" dur="1s" repeatCount="indefinite"/></path><path d="M5 18h14" stroke="#94A3B8" stroke-width="2" stroke-linecap="round"/></svg>`,
    "aero-arr-r-blue": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ar1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><path d="M5 12h14M12 5l7 7-7 7" stroke="url(#ar1)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 12h14" stroke="white" stroke-width="1" opacity="0.5" transform="translate(0, -1)"/></svg>`,
    "aero-arr-l-purple": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ar2" x1="1" y1="0" x2="0" y2="0"><stop offset="0%" stop-color="#C084FC"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs><path d="M19 12H5M12 19l-7-7 7-7" stroke="url(#ar2)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M19 12H5" stroke="white" stroke-width="1" opacity="0.5" transform="translate(0, -1)"/></svg>`,
    "aero-arr-u-green": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ar3" x1="0" y1="1" x2="0" y2="0"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M12 19V5M5 12l7-7 7 7" stroke="url(#ar3)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 19V5" stroke="white" stroke-width="1" opacity="0.5" transform="translate(-1, 0)"/></svg>`,
    "aero-arr-d-orange": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ar4" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FDBA74"/><stop offset="100%" stop-color="#EA580C"/></linearGradient></defs><path d="M12 5v14M19 12l-7 7-7-7" stroke="url(#ar4)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 5v14" stroke="white" stroke-width="1" opacity="0.5" transform="translate(-1, 0)"/></svg>`,
    "aero-arr-cycle": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ar5" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#3B82F6"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8" stroke="url(#ar5)" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M21 3v5h-5" stroke="url(#ar5)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    "aero-arr-shuffle": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16 3h5v5M4 20L21 3M21 16v5h-5M15 15l5 5M4 4l5 5" stroke="#6366F1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    "aero-arr-expand": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    "aero-arr-collapse": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 14h6v6M20 10h-6V4M10 14L3 21M14 10l7-7" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    "aero-arr-login": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4" stroke="#475569" stroke-width="2" stroke-linecap="round"/><path d="M10 17l5-5-5-5M15 12H3" stroke="#10B981" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    "aero-arr-logout": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" stroke="#475569" stroke-width="2" stroke-linecap="round"/><path d="M16 17l5-5-5-5M21 12H9" stroke="#EF4444" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    "aero-arr-chevron-r": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 18l6-6-6-6" stroke="#6366F1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M9 18l6-6-6-6" stroke="white" stroke-width="1" opacity="0.5" transform="translate(-1,0)"/></svg>`,
    "aero-arr-chevron-l": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15 18l-6-6 6-6" stroke="#6366F1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M15 18l-6-6 6-6" stroke="white" stroke-width="1" opacity="0.5" transform="translate(1,0)"/></svg>`,
    "aero-arr-chevron-u": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 15l-6-6-6 6" stroke="#6366F1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M18 15l-6-6-6 6" stroke="white" stroke-width="1" opacity="0.5" transform="translate(0,1)"/></svg>`,
    "aero-arr-chevron-d": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" stroke="#6366F1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M6 9l6 6 6-6" stroke="white" stroke-width="1" opacity="0.5" transform="translate(0,-1)"/></svg>`,
    "aero-arr-play": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ar-play" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#ar-play)" stroke="#047857" stroke-width="0.5"/><path d="M10 8l6 4-6 4V8z" fill="white"/><path d="M10 8l6 4-6 4" stroke="rgba(0,0,0,0.1)" stroke-width="1" fill="none"/></svg>`,
    "aero-ui-home": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" fill="url(#ui1)" stroke="#1D4ED8" stroke-width="0.5"/><path d="M9 22V12h6v10" fill="#1E3A8A" opacity="0.3"/><path d="M12 3l8 7" stroke="white" stroke-width="1" opacity="0.4"/></svg>`,
    "aero-ui-user": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A78BFA"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs><circle cx="12" cy="7" r="4" fill="url(#ui2)" stroke="#5B21B6" stroke-width="0.5"/><path d="M20 21v-2a4 4 0 0 0-3-3.8H7a4 4 0 0 0-3 3.8v2" fill="url(#ui2)" stroke="#5B21B6" stroke-width="0.5"/><circle cx="13" cy="6" r="1" fill="white" opacity="0.5"/></svg>`,
    "aero-ui-search": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#E0F2FE"/><stop offset="100%" stop-color="#38BDF8"/></linearGradient></defs><circle cx="11" cy="11" r="8" fill="url(#ui3)" stroke="#0284C7" stroke-width="0.5"/><path d="M21 21l-4.35-4.35" stroke="#0284C7" stroke-width="3" stroke-linecap="round"/><circle cx="11" cy="11" r="5" stroke="white" stroke-width="1" opacity="0.4"/></svg>`,
    "aero-ui-settings": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui4" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#94A3B8"/><stop offset="100%" stop-color="#475569"/></linearGradient></defs><path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" fill="#1E293B"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1.51 1H16a1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" fill="url(#ui4)" stroke="#334155" stroke-width="0.5"><animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="5s" repeatCount="indefinite"/></path></svg>`,
    "aero-ui-star": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui5" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FDE047"/><stop offset="100%" stop-color="#EAB308"/></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="url(#ui5)" stroke="#A16207" stroke-width="0.5"/><path d="M12 2l3 6 7 1" stroke="white" stroke-width="1" opacity="0.4" fill="none"/></svg>`,
    "aero-ui-heart": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui6" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FCA5A5"/><stop offset="100%" stop-color="#DC2626"/></linearGradient></defs><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5 0 0 0 0-7.78z" fill="url(#ui6)" stroke="#991B1B" stroke-width="0.5"/><path d="M6 8c1-2 4-3 6-1" stroke="white" stroke-width="1.5" opacity="0.5" fill="none"/></svg>`,
    "aero-ui-trash": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui7" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#94A3B8"/><stop offset="100%" stop-color="#475569"/></linearGradient></defs><path d="M3 6h18" stroke="#334155" stroke-width="2" stroke-linecap="round"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" fill="url(#ui7)" stroke="#334155" stroke-width="0.5"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" fill="#CBD5E1"/><line x1="10" y1="11" x2="10" y2="17" stroke="white" stroke-width="1" opacity="0.3"/><line x1="14" y1="11" x2="14" y2="17" stroke="white" stroke-width="1" opacity="0.3"/></svg>`,
    "aero-ui-edit": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui8" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#86EFAC"/><stop offset="100%" stop-color="#16A34A"/></linearGradient></defs><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" stroke="#14532D" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" fill="url(#ui8)" stroke="#14532D" stroke-width="0.5"/><path d="M16 5l3 3" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-ui-image": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ui9" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#F472B6"/><stop offset="100%" stop-color="#DB2777"/></linearGradient></defs><rect x="3" y="3" width="18" height="18" rx="2" fill="url(#ui9)" stroke="#9F1239" stroke-width="0.5"/><circle cx="8.5" cy="8.5" r="1.5" fill="white" opacity="0.8"/><path d="M21 15l-5-5L5 21" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>`,
    "aero-ui-link": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" stroke="#6366F1" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" fill="none"/></svg>`,
    "aero-chat-bubbles": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-chats" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A78BFA"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs><path d="M17 17l-1.5-4.5A5.5 5.5 0 0 0 12 3a5.5 5.5 0 0 0-5.5 5.5c0 2.8 2 5 4.5 5.5" fill="none" stroke="#5B21B6" stroke-width="2" stroke-linecap="round"/><path d="M21 15a5.5 5.5 0 0 0-5-5" fill="none" stroke="#5B21B6" stroke-width="2" stroke-linecap="round"/><path d="M7 13l-3 3 1-3A4 4 0 0 1 2 9a4 4 0 0 1 4-4" fill="none" stroke="#5B21B6" stroke-width="1.5" opacity="0.5"/><path d="M14 8a3 3 0 0 1 3 3" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-message-sent": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-msg" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M22 2L11 13" stroke="#064E3B" stroke-width="2" stroke-linecap="round"/><path d="M22 2l-7 20-4-9-9-4 20-7z" fill="url(#g-msg)" stroke="#064E3B" stroke-width="0.5"/><path d="M15 9l3-3" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-send-plane": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-send" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#3B82F6"/><stop offset="100%" stop-color="#1D4ED8"/></linearGradient></defs><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z" fill="url(#g-send)" stroke="#1E40AF" stroke-width="0.5"/><path d="M22 2L2 9l9 4 4 9 7-20z" stroke="white" stroke-width="1" opacity="0.3" fill="none"/></svg>`,
    "aero-share-nodes": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><radialGradient id="g-share" cx="50%" cy="50%"><stop offset="0%" stop-color="#F472B6"/><stop offset="100%" stop-color="#DB2777"/></radialGradient></defs><circle cx="18" cy="5" r="3" fill="url(#g-share)" stroke="#9F1239" stroke-width="0.5"/><circle cx="6" cy="12" r="3" fill="url(#g-share)" stroke="#9F1239" stroke-width="0.5"/><circle cx="18" cy="19" r="3" fill="url(#g-share)" stroke="#9F1239" stroke-width="0.5"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49" stroke="#9F1239" stroke-width="2"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49" stroke="#9F1239" stroke-width="2"/><circle cx="18" cy="5" r="1.5" fill="white" opacity="0.7"/></svg>`,
    "aero-phone-call": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-phone" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#4ADE80"/><stop offset="100%" stop-color="#16A34A"/></linearGradient></defs><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" fill="url(#g-phone)" stroke="#14532D" stroke-width="0.5"/><path d="M15 3h6M18 3l3 3M18 3l-3 3" stroke="#16A34A" stroke-width="2" stroke-linecap="round"/><path d="M5 5c1 2 3 4 5 4" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-envelope-mail": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-mail" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#E2E8F0"/><stop offset="100%" stop-color="#94A3B8"/></linearGradient></defs><rect x="2" y="4" width="20" height="16" rx="2" fill="url(#g-mail)" stroke="#475569" stroke-width="0.5"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" stroke="#475569" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M2 6l10 6 10-6" stroke="white" stroke-width="1" opacity="0.6" fill="none"/></svg>`,
    "aero-at-sign": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-at" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FCA5A5"/><stop offset="100%" stop-color="#DC2626"/></linearGradient></defs><circle cx="12" cy="12" r="4" fill="url(#g-at)" stroke="#991B1B" stroke-width="0.5"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94" stroke="#DC2626" stroke-width="2" stroke-linecap="round" fill="none"/><circle cx="12" cy="12" r="2" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-gift-box": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-gift" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#EC4899"/><stop offset="100%" stop-color="#BE123C"/></linearGradient></defs><rect x="3" y="8" width="18" height="14" rx="2" fill="url(#g-gift)" stroke="#9F1239" stroke-width="0.5"/><path d="M12 5a3 3 0 1 0-3 3h6a3 3 0 1 0-3-3z" fill="#F472B6" stroke="#9F1239" stroke-width="0.5"/><path d="M12 8v14M3 13h18" stroke="#9F1239" stroke-width="2"/><path d="M12 2v6M7.5 5h9" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-media-pause": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-pause" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FDBA74"/><stop offset="100%" stop-color="#EA580C"/></linearGradient></defs><rect x="6" y="4" width="4" height="16" rx="1" fill="url(#g-pause)" stroke="#C2410C" stroke-width="0.5"/><rect x="14" y="4" width="4" height="16" rx="1" fill="url(#g-pause)" stroke="#C2410C" stroke-width="0.5"/><path d="M7 4h2M15 4h2" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-media-stop": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-stop" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FCA5A5"/><stop offset="100%" stop-color="#DC2626"/></linearGradient></defs><rect x="4" y="4" width="16" height="16" rx="2" fill="url(#g-stop)" stroke="#991B1B" stroke-width="0.5"/><rect x="6" y="6" width="12" height="12" rx="1" stroke="white" stroke-width="1" opacity="0.4" fill="none"/></svg>`,
    "aero-media-skip-fwd": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-skipf" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><path d="M5 18l10-6-10-6v12z" fill="url(#g-skipf)" stroke="#1E40AF" stroke-width="0.5"/><rect x="17" y="5" width="4" height="14" rx="1" fill="url(#g-skipf)" stroke="#1E40AF" stroke-width="0.5"/><path d="M5 7l8 5-8 5" stroke="white" stroke-width="1" opacity="0.4" fill="none"/></svg>`,
    "aero-media-skip-back": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-skipb" x1="1" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><path d="M19 18l-10-6 10-6v12z" fill="url(#g-skipb)" stroke="#1E40AF" stroke-width="0.5"/><rect x="3" y="5" width="4" height="14" rx="1" fill="url(#g-skipb)" stroke="#1E40AF" stroke-width="0.5"/><path d="M19 7l-8 5 8 5" stroke="white" stroke-width="1" opacity="0.4" fill="none"/></svg>`,
    "aero-music-note": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-music" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#C084FC"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs><circle cx="9" cy="18" r="4" fill="url(#g-music)" stroke="#5B21B6" stroke-width="0.5"/><circle cx="19" cy="15" r="4" fill="url(#g-music)" stroke="#5B21B6" stroke-width="0.5"/><path d="M9 18V7l10-3v11" stroke="#5B21B6" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M9 10l10-3" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-camera-photo": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-cam" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#E2E8F0"/><stop offset="100%" stop-color="#64748B"/></linearGradient><radialGradient id="g-lens" cx="50%" cy="50%"><stop offset="0%" stop-color="#3B82F6"/><stop offset="100%" stop-color="#1E3A8A"/></radialGradient></defs><rect x="2" y="6" width="20" height="14" rx="3" fill="url(#g-cam)" stroke="#475569" stroke-width="0.5"/><path d="M8 6L10 3h4l2 3" fill="#64748B"/><circle cx="12" cy="13" r="5" fill="url(#g-lens)" stroke="#1E40AF" stroke-width="1"/><circle cx="19" cy="9" r="1" fill="#EF4444"/><path d="M12 10a3 3 0 0 1 3 3" stroke="white" stroke-width="1" opacity="0.4" fill="none"/></svg>`,
    "aero-video-film": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-vid" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A78BFA"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs><rect x="2" y="4" width="16" height="16" rx="2" fill="url(#g-vid)" stroke="#5B21B6" stroke-width="0.5"/><path d="M22 8l-4 3v2l4 3V8z" fill="#7C3AED" stroke="#5B21B6" stroke-width="0.5"/><circle cx="10" cy="12" r="4" stroke="white" stroke-width="1" opacity="0.5" fill="none"/><path d="M2 6h16M2 18h16" stroke="white" stroke-width="1" opacity="0.3"/></svg>`,
    "aero-game-controller": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-game" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#FCA5A5"/><stop offset="100%" stop-color="#DC2626"/></linearGradient></defs><rect x="2" y="6" width="20" height="12" rx="6" fill="url(#g-game)" stroke="#991B1B" stroke-width="0.5"/><circle cx="7" cy="12" r="2" fill="#7F1D1D" opacity="0.5"/><circle cx="17" cy="12" r="2" fill="#7F1D1D" opacity="0.5"/><path d="M6 12h2M7 11v2" stroke="white" stroke-width="2" stroke-linecap="round"/><circle cx="17" cy="10" r="1" fill="white"/><circle cx="19" cy="12" r="1" fill="white"/><circle cx="17" cy="14" r="1" fill="white"/><circle cx="15" cy="12" r="1" fill="white"/></svg>`,
    "aero-weather-sun": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><radialGradient id="g-sun" cx="50%" cy="50%"><stop offset="0%" stop-color="#FDE047"/><stop offset="100%" stop-color="#F97316"/></radialGradient></defs><circle cx="12" cy="12" r="6" fill="url(#g-sun)" stroke="#EA580C" stroke-width="0.5"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.9 4.9l2.1 2.1M17 17l2.1 2.1M4.9 19.1l2.1-2.1M17 7l2.1-2.1" stroke="#F97316" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="12" r="4" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-weather-moon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-moon" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#E0F2FE"/><stop offset="100%" stop-color="#60A5FA"/></linearGradient></defs><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" fill="url(#g-moon)" stroke="#2563EB" stroke-width="0.5"/><path d="M14 8a3 3 0 0 0-3 3" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-weather-cloud": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-cloud" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#F1F5F9"/><stop offset="100%" stop-color="#94A3B8"/></linearGradient></defs><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" fill="url(#g-cloud)" stroke="#64748B" stroke-width="0.5"/><path d="M6 10a3 3 0 0 1 6 0" stroke="white" stroke-width="1" opacity="0.6" fill="none"/></svg>`,
    "aero-weather-rain": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-rain" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#1E40AF"/></linearGradient></defs><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" fill="#CBD5E1" stroke="#94A3B8" stroke-width="0.5" opacity="0.5"/><line x1="8" y1="21" x2="8" y2="23" stroke="url(#g-rain)" stroke-width="2" stroke-linecap="round"/><line x1="12" y1="20" x2="12" y2="22" stroke="url(#g-rain)" stroke-width="2" stroke-linecap="round"/><line x1="16" y1="21" x2="16" y2="23" stroke="url(#g-rain)" stroke-width="2" stroke-linecap="round"/></svg>`,
    "aero-nature-leaf": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-leaf" x1="0" y1="1" x2="1" y2="0"><stop offset="0%" stop-color="#4ADE80"/><stop offset="100%" stop-color="#15803D"/></linearGradient></defs><path d="M12 20.5c-2.5-4.5-7-8-7-13 0-2.5 2-4.5 4.5-4.5 3.5 0 7 3.5 9 9-4.5 2-8 5.5-8 9-2.5-1.5-5-4-6.5-6.5" fill="url(#g-leaf)" stroke="#166534" stroke-width="0.5"/><path d="M12 20.5c2-3.5 5.5-7 9-9" stroke="#166534" stroke-width="1"/><path d="M9.5 3a4.5 4.5 0 0 1 4.5 4.5" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-water-drop": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-drop" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#38BDF8"/><stop offset="100%" stop-color="#0284C7"/></linearGradient></defs><path d="M12 2c0 5-6 8-6 13a6 6 0 0 0 12 0c0-5-6-8-6-13z" fill="url(#g-drop)" stroke="#075985" stroke-width="0.5"/><path d="M12 4c1 3 4 5 4 10" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-star-shining": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-star" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FDE047"/><stop offset="100%" stop-color="#EAB308"/></linearGradient></defs><path d="M12 2l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z" fill="url(#g-star)" stroke="#A16207" stroke-width="0.5"/><circle cx="12" cy="12" r="10" stroke="#EAB308" stroke-width="1" fill="none" opacity="0.2"/><path d="M12 2l3 6 7 1" stroke="white" stroke-width="1" opacity="0.6" fill="none"/></svg>`,
    "aero-planet-ring": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-planet" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#C084FC"/><stop offset="100%" stop-color="#6B21A8"/></linearGradient></defs><circle cx="12" cy="12" r="7" fill="url(#g-planet)" stroke="#5B21B6" stroke-width="0.5"/><ellipse cx="12" cy="12" rx="11" ry="4" stroke="#E9D5FF" stroke-width="1" fill="none" transform="rotate(-30 12 12)"/><path d="M7 12a5 5 0 0 1 5-5" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-bolt-flash": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-bolt" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FDE047"/><stop offset="100%" stop-color="#F59E0B"/></linearGradient></defs><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="url(#g-bolt)" stroke="#D97706" stroke-width="0.5"/><path d="M13 2L3 14h4" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-map-pin": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-pin" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FCA5A5"/><stop offset="100%" stop-color="#DC2626"/></linearGradient></defs><path d="M12 2a7 7 0 0 0-7 7c0 5 7 13 7 13s7-8 7-13a7 7 0 0 0-7-7z" fill="url(#g-pin)" stroke="#991B1B" stroke-width="0.5"/><circle cx="12" cy="9" r="3" fill="#7F1D1D"/><path d="M12 2a7 7 0 0 0-7 7c0 2 1 4 3 6" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-map-folded": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-map" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#E2E8F0"/><stop offset="100%" stop-color="#CBD5E1"/></linearGradient></defs><path d="M9 18l-7-2V4l7 2 8-2 5 2v12l-5-2-8 2z" fill="url(#g-map)" stroke="#475569" stroke-width="0.5"/><path d="M9 4v14M17 4v14" stroke="#475569" stroke-width="1.5"/><path d="M2 4l7 2 8-2" stroke="white" stroke-width="1" opacity="0.6" fill="none"/></svg>`,
    "aero-navigate-gps": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-nav" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#3B82F6"/><stop offset="100%" stop-color="#1D4ED8"/></linearGradient></defs><path d="M12 2L2 22l10-4 10 4L12 2z" fill="url(#g-nav)" stroke="#1E40AF" stroke-width="0.5"/><path d="M12 2L2 22l10-4" stroke="white" stroke-width="1" opacity="0.4" fill="none"/></svg>`,
    "aero-compass-north": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-comp" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#F1F5F9"/><stop offset="100%" stop-color="#94A3B8"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#g-comp)" stroke="#64748B" stroke-width="0.5"/><polygon points="12 6 14 12 12 18 10 12 12 6" fill="#EF4444"/><polygon points="12 6 14 12 10 12" fill="#FCA5A5"/><path d="M12 2a10 10 0 0 1 7 3" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-globe-world": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-globe" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#g-globe)" stroke="#1E40AF" stroke-width="0.5"/><path d="M2 12h20M12 2a15 15 0 0 1 0 20M12 2a15 15 0 0 0 0 20" stroke="#1E40AF" stroke-width="1" fill="none"/><path d="M12 2c3 0 6 2 8 5" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-chip-cpu": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-chip" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FCD34D"/><stop offset="100%" stop-color="#B45309"/></linearGradient></defs><rect x="4" y="4" width="16" height="16" rx="1" fill="url(#g-chip)" stroke="#92400E" stroke-width="0.5"/><rect x="8" y="8" width="8" height="8" fill="#92400E" opacity="0.5"/><path d="M4 8H2M4 12H2M4 16H2M20 8h2M20 12h2M20 16h2M8 4V2M12 4V2M16 4V2M8 20v2M12 20v2M16 20v2" stroke="#92400E" stroke-width="1.5"/><path d="M4 6h16" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-robot-face": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-bot" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A7F3D0"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><rect x="4" y="6" width="16" height="12" rx="2" fill="url(#g-bot)" stroke="#047857" stroke-width="0.5"/><circle cx="8" cy="12" r="1.5" fill="#047857"/><circle cx="16" cy="12" r="1.5" fill="#047857"/><path d="M10 16h4" stroke="#047857" stroke-width="1.5"/><path d="M12 2v4M4 10H2M20 10h2" stroke="#047857" stroke-width="2"/><path d="M4 8h16" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-ai-sparkle": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-ai" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#C084FC"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><path d="M12 2l3 7 7 2-7 2-3 7-3-7-7-2 7-2z" fill="url(#g-ai)" stroke="#5B21B6" stroke-width="0.5"/><path d="M12 2l3 7 7 2" stroke="white" stroke-width="1" opacity="0.5" fill="none"/><circle cx="4" cy="20" r="2" fill="url(#g-ai)"/><circle cx="20" cy="4" r="1" fill="url(#g-ai)"/></svg>`,
    "aero-wallet-pass": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-wall" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A16207"/><stop offset="100%" stop-color="#713F12"/></linearGradient></defs><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z" fill="url(#g-wall)" stroke="#451A03" stroke-width="0.5"/><path d="M2 10h20" stroke="#451A03" stroke-width="1"/><circle cx="18" cy="14" r="2" fill="#FCD34D" stroke="#B45309" stroke-width="1"/><path d="M4 6h16" stroke="white" stroke-width="1" opacity="0.3"/></svg>`,
    "aero-presentation-chart": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-pres" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#E2E8F0"/><stop offset="100%" stop-color="#94A3B8"/></linearGradient></defs><rect x="2" y="4" width="20" height="14" rx="1" fill="url(#g-pres)" stroke="#475569" stroke-width="0.5"/><path d="M12 18v4M8 22h8" stroke="#475569" stroke-width="2"/><path d="M6 14l4-4 4 4 4-6" stroke="#2563EB" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M2 6h20" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-chart-pie-simple": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#60A5FA" stroke="#2563EB" stroke-width="0.5"/><path d="M12 12L12 2A10 10 0 0 1 22 12" fill="#F472B6" stroke="#DB2777" stroke-width="0.5"/><path d="M12 12L22 12A10 10 0 0 1 12 22" fill="#34D399" stroke="#059669" stroke-width="0.5"/><path d="M12 2a10 10 0 0 1 5 2" stroke="white" stroke-width="1" opacity="0.5" fill="none"/></svg>`,
    "aero-coins-stack": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-coin" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FDE047"/><stop offset="100%" stop-color="#D97706"/></linearGradient></defs><ellipse cx="12" cy="18" rx="8" ry="3" fill="url(#g-coin)" stroke="#B45309" stroke-width="0.5"/><ellipse cx="12" cy="14" rx="8" ry="3" fill="url(#g-coin)" stroke="#B45309" stroke-width="0.5"/><ellipse cx="12" cy="10" rx="8" ry="3" fill="url(#g-coin)" stroke="#B45309" stroke-width="0.5"/><path d="M12 7c2 0 4 1 4 3" stroke="white" stroke-width="1" opacity="0.6" fill="none"/></svg>`,
    "aero-briefcase-business": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-brief" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#64748B"/><stop offset="100%" stop-color="#334155"/></linearGradient></defs><rect x="3" y="8" width="18" height="12" rx="2" fill="url(#g-brief)" stroke="#1E293B" stroke-width="0.5"/><path d="M9 8V6a3 3 0 0 1 6 0v2" stroke="#334155" stroke-width="2"/><rect x="11" y="13" width="2" height="3" fill="#CBD5E1"/><path d="M3 10h18" stroke="white" stroke-width="1" opacity="0.2"/></svg>`,
    "aero-format-bold": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-bold" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#475569"/><stop offset="100%" stop-color="#1E293B"/></linearGradient></defs><path d="M7 5h6a4 4 0 0 1 0 8H7z" fill="url(#g-bold)" stroke="#1E293B" stroke-width="0.5"/><path d="M7 13h7a4 4 0 0 1 0 8H7z" fill="url(#g-bold)" stroke="#1E293B" stroke-width="0.5"/><path d="M7 5v16" stroke="#1E293B" stroke-width="2"/><path d="M7 7h6" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-format-italic": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-italic" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#475569"/><stop offset="100%" stop-color="#1E293B"/></linearGradient></defs><path d="M10 5h9M5 19h9M14 5l-4 14" stroke="url(#g-italic)" stroke-width="2" stroke-linecap="round"/><path d="M10 5h9" stroke="white" stroke-width="1" opacity="0.5" transform="translate(0, -1)"/></svg>`,
    "aero-format-list-bullet": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-list" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs><circle cx="5" cy="7" r="2" fill="url(#g-list)"/><circle cx="5" cy="12" r="2" fill="url(#g-list)"/><circle cx="5" cy="17" r="2" fill="url(#g-list)"/><path d="M10 7h10M10 12h10M10 17h10" stroke="#1E40AF" stroke-width="2" stroke-linecap="round"/><path d="M10 7h10" stroke="white" stroke-width="1" opacity="0.5" transform="translate(0, -1)"/></svg>`,
    "aero-align-center": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g-align" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#94A3B8"/><stop offset="100%" stop-color="#475569"/></linearGradient></defs><rect x="3" y="6" width="18" height="2" rx="1" fill="url(#g-align)"/><rect x="6" y="11" width="12" height="2" rx="1" fill="url(#g-align)"/><rect x="4" y="16" width="16" height="2" rx="1" fill="url(#g-align)"/><path d="M3 6h18" stroke="white" stroke-width="1" opacity="0.5"/></svg>`,
    "aero-link-url": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" stroke="#2563EB" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M12 12h.01" stroke="white" stroke-width="2" opacity="0.8"/></svg>`,
    "aero-load-galaxy": `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="grad-gal" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A78BFA"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient></defs>
    <circle cx="12" cy="12" r="3" fill="url(#grad-gal)">
        <animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/>
    </circle>
    <ellipse cx="12" cy="12" rx="10" ry="4" stroke="#8B5CF6" stroke-width="0.5" fill="none" transform="rotate(0 12 12)">
        <animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="3s" repeatCount="indefinite"/>
    </ellipse>
    <ellipse cx="12" cy="12" rx="10" ry="4" stroke="#60A5FA" stroke-width="0.5" fill="none" transform="rotate(60 12 12)">
        <animateTransform attributeName="transform" type="rotate" from="60 12 12" to="420 12 12" dur="3s" repeatCount="indefinite"/>
    </ellipse>
    <ellipse cx="12" cy="12" rx="10" ry="4" stroke="#34D399" stroke-width="0.5" fill="none" transform="rotate(120 12 12)">
        <animateTransform attributeName="transform" type="rotate" from="120 12 12" to="480 12 12" dur="3s" repeatCount="indefinite"/>
    </ellipse>
    </svg>`,
    "aero-load-liquid-ring": `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="grad-liq-ring" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs>
    <path d="M12 2a10 10 0 0 1 10 10" stroke="url(#grad-liq-ring)" stroke-width="3" stroke-linecap="round" fill="none">
        <animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1s" repeatCount="indefinite"/>
    </path>
    <circle cx="12" cy="12" r="8" stroke="#10B981" stroke-width="1" opacity="0.2" stroke-dasharray="2 4"/>
    <circle cx="12" cy="2" r="2" fill="#34D399">
         <animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1s" repeatCount="indefinite"/>
    </circle>
    </svg>`,
    "aero-load-pulse-orb": `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="grad-orb" cx="50%" cy="50%"><stop offset="0%" stop-color="#FCA5A5"/><stop offset="100%" stop-color="#DC2626"/></radialGradient></defs>
    <circle cx="12" cy="12" r="4" fill="url(#grad-orb)">
        <animate attributeName="r" values="4;8;4" dur="1.5s" repeatCount="indefinite"/>
        <animate attributeName="opacity" values="1;0.5;1" dur="1.5s" repeatCount="indefinite"/>
    </circle>
    <circle cx="12" cy="12" r="10" stroke="#EF4444" stroke-width="0.5" fill="none">
        <animate attributeName="r" values="10;12;10" dur="1.5s" repeatCount="indefinite"/>
        <animate attributeName="opacity" values="0.2;0;0.2" dur="1.5s" repeatCount="indefinite"/>
    </circle>
    </svg>`,
    "aero-load-radar-sweep": `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="grad-rad" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#60A5FA" stop-opacity="0"/><stop offset="100%" stop-color="#2563EB"/></linearGradient></defs>
    <circle cx="12" cy="12" r="10" stroke="#3B82F6" stroke-width="1" fill="#1E3A8A" fill-opacity="0.1"/>
    <circle cx="12" cy="12" r="6" stroke="#3B82F6" stroke-width="0.5" opacity="0.5"/>
    <circle cx="12" cy="12" r="2" fill="#3B82F6"/>
    <path d="M12 12L12 2A10 10 0 0 1 22 12" fill="url(#grad-rad)">
        <animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="1.5s" repeatCount="indefinite"/>
    </path>
    </svg>`,
    "aero-load-flower": `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <g>
        <circle cx="12" cy="4" r="2" fill="#F472B6"/>
        <circle cx="19" cy="8" r="2" fill="#818CF8"/>
        <circle cx="19" cy="16" r="2" fill="#34D399"/>
        <circle cx="12" cy="20" r="2" fill="#FBBF24"/>
        <circle cx="5" cy="16" r="2" fill="#F87171"/>
        <circle cx="5" cy="8" r="2" fill="#A78BFA"/>
        <animateTransform attributeName="transform" type="rotate" from="0 12 12" to="360 12 12" dur="2s" repeatCount="indefinite"/>
    </g>
    </svg>`,
    "aero-ui-toggle-on": `<svg viewBox="0 0 24 24"><defs><linearGradient id="g-tog-on" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#4ADE80"/><stop offset="100%" stop-color="#16A34A"/></linearGradient></defs><rect x="2" y="6" width="20" height="12" rx="6" fill="url(#g-tog-on)" stroke="#14532D" stroke-width="0.5"/><circle cx="16" cy="12" r="5" fill="white" filter="drop-shadow(0 1px 2px rgba(0,0,0,0.2))"/></svg>`,
    "aero-ui-toggle-off-outline": `<rect x="2" y="6" width="20" height="12" rx="6" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="8" cy="12" r="4" fill="currentColor" opacity="0.3"/>`,
};
